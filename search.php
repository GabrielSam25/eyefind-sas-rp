...
$resultados_busca = buscarWebsites($pdo, $termo_busca);
?>
...
<head>
    ...
    <title>Eyefind.info - Resultados da Busca</title>
...
<body class="bg-eyefind-light">
                        ...
                        <form action="search.php" method="GET">
                            <div class="relative">
                                <input type="text" name="q"
                                    ...
                                    placeholder="Procurar no Eyefind" value="<?php echo htmlspecialchars($termo_busca); ?>">
    ...
    <div class="max-w-6xl mx-auto">
        <div class="p-3 mt-1">
            <h3 class="text-lg font-bold text-eyefind-blue mb-4">Resultados para: "<?php echo htmlspecialchars($termo_busca); ?>"</h3>
            <?php if (empty($resultados_busca)): ?>
                <p class="text-eyefind-dark">Nenhum resultado encontrado.</p>
            <?php else: ?>
                <div class="grid grid-cols-1 gap-4">
                    <?php foreach ($resultados_busca as $website): ?>
